...
<title>Prolongar Actividad Tv</title>
...
<script type="text/javascript" >
    ...
    function validar(form){
	    ...
	    if(form.numHora.value==""){
			alert("Debe introducir el numero de horas");
			form.numHora.focus();
			return false;
	    }	
	}
...
<body >
	...
	<table width="400" border="0" align="center">
		<tr class="elegiropcion"> <td> Prolongar actividad Tv</td></tr>
		<tr> <td> <br /></td></tr>
	</table>
	...
	<form id="frm" name="frm" method="post" action="Respuesta.php?paginaactual=<?php echo $paginaactual ?>">
		<table width="400" border="0" align="center">
			...
			<tr>
				<td>N&ordm; horas</td>
				<td><input name="numHora" type="text" onKeyPress="LP_data(event)" size="10" value=""/></td>
			</tr> 
		</table>
